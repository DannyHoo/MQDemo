package com.danny.mq.rabbitmq.utils.test;
...
public class Executor {
    ...
    public void start(int threadNum) {
        cyclicBarrier=new CyclicBarrier(threadNum);
        //初始化相关容器
        ...
        System.out.println("平均耗时：" + (timeConsumeTotal/threadNum));
